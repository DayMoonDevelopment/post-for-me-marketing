...
export const meta: Route.MetaFunction = ({ data }) => {
  const canonicalUrl = "https://www.postforme.dev/integrations/linkedin";
  ...
  return [
    ...
    { property: "og:image:alt", content: "LinkedIn API Integration — Post for Me" },
    ...
    {
      name: "keywords",
      content: "LinkedIn API, LinkedIn integration, LinkedIn posting API, LinkedIn company page API, LinkedIn analytics API, social media API, unified social API",
    },
    {
      "script:ld+json": {
        "@context": "https://schema.org",
        "@type": "TechArticle",
        headline: "LinkedIn Integration",
    ...
    },
    {
      "script:ld+json": {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "LinkedIn", item: canonicalUrl },
        ],
      },
    },
  ];
