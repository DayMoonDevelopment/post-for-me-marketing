...
export const meta: Route.MetaFunction = ({ data }) => {
  const canonicalUrl = "https://www.postforme.dev/integrations/tiktok";
  ...
  return [
    ...
    { property: "og:image:alt", content: "TikTok API Integration — Post for Me" },
    ...
    {
      name: "keywords",
      content: "TikTok API, TikTok integration, TikTok posting API, TikTok Business API, TikTok analytics API, social media API, unified social API",
    },
    {
      "script:ld+json": {
        "@context": "https://schema.org",
        "@type": "TechArticle",
        headline: "TikTok Integration",
    ...
    },
    {
      "script:ld+json": {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "TikTok", item: canonicalUrl },
        ],
      },
    },
  ];
