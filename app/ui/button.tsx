  ...
  "cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "bg-background text-foreground border border-input hover:bg-secondary data-[state=open]:bg-secondary",
        dashed:
          "text-foreground border border-input border-dashed bg-background hover:bg-secondary hover:text-foreground data-[state=open]:text-foreground",
        ghost:
...
interface ButtonArrowProps extends React.SVGProps<SVGSVGElement> {
  icon?: FunctionComponent<CentralIconBaseProps>; // Allows passing any Lucide icon
}
